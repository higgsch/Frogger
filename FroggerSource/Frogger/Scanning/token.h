...
typedef enum token_types {
	NOTOK = -1, 
	ASSIGND, ADD, SUB, MUL, DIV, MOD, IDIV, ROOT, EXP,
	ASSIGNS, CONCATS, CONCATD, CONCATA,
...
public:
	...
	static Token ROOT;
	static Token EXP;
	static Token ASSIGNS;
	static Token CONCATS;
	static Token CONCATD; 
	static Token CONCATA;
	static Token NOT;
	static Token LT;
	static Token GT;
	static Token EQ;
